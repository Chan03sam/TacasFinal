...
if (isset($_GET['year'])) {
    ...
    $archives = $conn->query("SELECT * FROM archive_list WHERE YEAR(date_created) = '$selectedYear' AND status = 1 ORDER BY unix_timestamp(date_created) DESC");
        ...
        <div class="col-12">
            <div class="card card-outline card-success shadow rounded-0">
                <div class="card-body rounded-0">
                    <h2>Archive List of <?= $selectedYear ?></h2>
                    <hr class="bg-navy">
                    <?php 
                        $limit = 10;
                        ...
                        $count_all = $conn->query("SELECT * FROM archive_list WHERE status = 1")->num_rows;    
                        ...
                        <a href="./?page=view_archive&id=<?= $row['id'] ?>" class="text-decoration-none text-dark list-group-item list-group-item-action">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-7 col-sm-12">
                                    ...
                                    <small class="text-muted">By <b class="text-info">Asia Technological School of Science and Arts</b></small>
