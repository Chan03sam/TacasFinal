<div class="content py-2" readonly>
    <div class="col-12">
            ...
            <div class="card-body rounded-0">
                ...
                $student_arr = "Asia Technological School of Science and Arts";
                $count_all = $conn->query("SELECT * FROM archive_list where `status` = 1 {$search}")->num_rows;    
                $pages = ceil($count_all/$limit);
                $archives = $conn->query("SELECT * FROM archive_list WHERE `status` = 1 {$search} ORDER BY views_count DESC, unix_timestamp(date_created) DESC {$paginate}");    
                ?>
                    ...
                    <a href="./?page=view_archive&id=<?= $row['id'] ?>" class="text-decoration-none text-dark list-group-item list-group-item-action">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-12">
                                ...
                                <small class="text-muted">By <b class="text-info"><?= isset($student_arr) ? $student_arr : "N/A" ?></b></small>
